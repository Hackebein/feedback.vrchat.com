...
type Config struct {
	...
	// ScraperUserID is the Canny user id of the SSO scrape bot; omitted from
	// voter diffs and ignored for vote events attributable only to that user.
...
func loadConfig() (Config, error) {
	cfg := Config{
		...
		ScraperUserID:   envStr("SCRAPER_CANNY_USER_ID", ""),
	}
